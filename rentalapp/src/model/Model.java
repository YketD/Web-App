...
public class Model
{
    ...
    public Model()
    {
        ...
        // Pre-defined users
        users.add(new Customer("marcel", "marcel"));
        users.add(new Owner("yke", "yke"));

        // Pre-defined apartments
        apartments.add(new Apartment("yke", 2, 3000, "Enschede"));
        apartments.add(new Apartment("yke", 4, 2000, "Enschede"));
        apartments.add(new Apartment("yke", 6, 8000, "Hengelo"));
    }
